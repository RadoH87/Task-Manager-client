...
export const NavBar = () => {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-gray-800 py-4 lg:px-12 shadow border-solid border-t-2 border-blue-700">
      <div className="flex justify-between lg:w-auto w-full lg:border-b-0 pl-6 pr-2 border-solid border-b-2 border-gray-300 pb-5 lg:pb-0">
        <div className="flex items-center flex-shrink-0 text-gray-800 mr-16">
          <span className="font-semibold text-xl text-white tracking-tight flex justify-center items-center gap-2">
            Task<span className="font-bold text-blue-700">Manager</span>
          </span>
        </div>
      </div>
      <div className="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
        ...
        <div className="flex ">
          <a
            ...
            className="cursor-pointer block text-md px-4 py-2 text-white rounded font-bold hover:text-white mt-4 hover:bg-blue-700 lg:mt-0"
          >
            Log out
          </a>
        </div>
