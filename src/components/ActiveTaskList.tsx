...
export const ActiveTaskList = (props: ActiveTaskListProps) => {
  return (
    <li className="border-gray-400 mt-4 flex flex-row">
      <div className="select-none mt-4 bg-gray-800 flex flex-1 items-center p-4 transition duration-500 ease-in-out transform hover:-translate-y-2 rounded-2xl border-b-2 p-6 hover:shadow-2xl border-white text-white">
